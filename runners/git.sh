...
export LZ_LIBRARY_PATH="../srcs/git/mod-lib:../srcs/git/mod-lib/lib/x86_64-linux-gnu:/lib/x86_64-linux-gnu:/usr/lib/x86_64-linux-gnu/"

# Path points to our lzload and fake libraries
export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:../srcs/git/lib"

git clone https://github.com/petablox/lzload
$HOME/dep-trace/scripts/fold.py -d .
rm -rf ./lzload

git --help
$HOME/dep-trace/scripts/fold.py -d .

git clone git@github.com:petablox/lzload.git
$HOME/dep-trace/scripts/fold.py -d .
